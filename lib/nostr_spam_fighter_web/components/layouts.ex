defmodule NostrSpamFighterWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ...
    <div class="min-h-screen bg-base-200">
      <header class="border-b border-base-300 bg-base-100 px-6 py-4">
        <div class="flex items-end justify-between gap-8">
          <div>
            <p class="text-xs uppercase tracking-[0.35em]">Pareto</p>
            <a href={~p"/dashboard"} class="text-2xl font-semibold">Nostr Spam Fighter</a>
          </div>
